...
<meta charset="utf-8" />
<title>Cook - A - Roo | Khao aur Khilao | About Us</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="default-section padding-60">
    	<div class="auto-container">
            <div class="row clearfix">
            	...
            	<article class="col-md-8 col-sm-6 col-xs-12 text-column wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                	<div class="inner">
                        <div class="sec-title"><h2>Meetings, events and conferences</h2></div>
                        <div class="text">
                ...
                <article class="col-md-4 col-sm-6 col-xs-12 listing-column wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                	<div class="inner">
                        <h3>What we do on MeetOn?</h3>
                        <div class="check-listing">
                        	<ul>
                            	<li>Business Rearch for Marketing</li>
                                <li>Event Strategy Planning</li>
                                <li>Set Business Meetings &amp; Events</li>
                                <li>Learning Courses for Beginners</li>
                                <li>Trainee for talented Speakers</li>
                            </ul>
                            <br>
                            <a href="#" class="theme-btn btn-style-one hvr-bounce-to-right"><span class="fa fa-play"></span> SIGN UP AT MEETON</a>
                        </div>
                	</div>
                </article>
    ...
    <section class="two-column">
    	<div class="auto-container">
            <div class="row clearfix">
                ...
                <!--Image Side-->
                <div class="col-md-6 col-sm-6 col-xs-12 pull-left image-side wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms" style="background-image:url(images/resource/columned-image-2.jpg);">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 pull-right content-side wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                	<h2>We create meetings for you!</h2>
    ...
    <!--Default Section-->
    <section class="default-section with-testimonials padding-70">
    	<div class="auto-container">
        	<div class="row clearfix">
            	
                <!--Testimonials-->
            	<div class="col-md-6 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                	<div class="sec-title"><h2>What does our clients say?</h2></div>
                ...
                <!--Our Experience-->
                <div class="col-md-6 col-sm-12 col-xs-12 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                	<div class="sec-title"><h2>Our experiences at Meeton</h2></div>
                    <div class="our-experience">
                		
                        <div class="exp-block">
                        	<div class="exp-header">
                            	<h3>Creating outdoor events</h3>
                            </div>
                            <div class="exp-meter" data-value="84%"><div class="exp-count">84%</div></div>
                        </div>
                        
                        <div class="exp-block">
                        	<div class="exp-header">
                            	<h3>Event and meeting managements</h3>
                            </div>
                            <div class="exp-meter" data-value="76%"><div class="exp-count">76%</div></div>
                        </div>
                        
                        <div class="exp-block">
                        	<div class="exp-header">
                            	<h3>Planning trainings and courses</h3>
                            </div>
                            <div class="exp-meter" data-value="92%"><div class="exp-count">92%</div></div>
                        </div>
                        
                        <div class="exp-block">
                        	<div class="exp-header">
                            	<h3>Company analysis and strategy planing</h3>
                            </div>
                            <div class="exp-meter" data-value="88%"><div class="exp-count">88%</div></div>
                        </div>
    ...
    <!--Sponsors-->
    <section class="sponsors style-two" style="background-image:url(images/background/sponsor-bg.jpg);">
    	<div class="auto-container">
        	<ul class="slider">
            	<li><a href="#"><img src="images/clients/logo-1.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-2.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-3.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-4.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-5.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-1.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-2.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-3.png" alt="" title=""></a></li>
                <li><a href="#"><img src="images/clients/logo-4.png" alt="" title=""></a></li>
