...
<asp:Content ID="CommentContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <asp:GridView ID="GridView1" style="margin-top:20px; text-align:center" CellPadding="5" AllowPaging="True" CellSpacing="2" runat="server" AutoGenerateColumns="False" DataSourceID="LinqDataSource1"  Width="500px" >
                    <Columns>
